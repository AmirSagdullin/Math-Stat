...
def sign_test(data_A, p, n):
    statistic = len(data_A)
    p_value = binom.cdf(statistic, n, p)
    return statistic, p_value

statistic, p_value = sign_test(data_A, alpha, n)
m = statistic # количество А в выборке
...
print("5%-Критическая область:", critical_region) # правая граница

# Критическое значение по формуле биномиального распределения
